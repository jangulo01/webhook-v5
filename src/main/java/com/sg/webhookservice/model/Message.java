...
public class Message {
    ...
    /**
     * Información del cliente que originó el webhook (almacenada como JSON)
     * Puede incluir IP, User-Agent, etc.
     */
    @Column(columnDefinition = "jsonb")
    private String clientInfo;
    
    /**
     * Metadatos adicionales asociados al mensaje (almacenados como JSON)
     */
    @Column(columnDefinition = "jsonb")
